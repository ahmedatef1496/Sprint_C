...
static void WriteIns(u8 ins)
{
	...
	DIO_write(LCD_PORT,D7,GET_BIT(ins,7));
	DIO_write(LCD_PORT,D6,GET_BIT(ins,6));
	DIO_write(LCD_PORT,D5,GET_BIT(ins,5));
	DIO_write(LCD_PORT,D4,GET_BIT(ins,4));
	 DIO_write(LCD_PORT,EN,HIGH);
	_delay_ms(1);
	 DIO_write(LCD_PORT,EN,LOW);
	_delay_ms(1);
	DIO_write(LCD_PORT,D7,GET_BIT(ins,3));
	DIO_write(LCD_PORT,D6,GET_BIT(ins,2));
	DIO_write(LCD_PORT,D5,GET_BIT(ins,1));
	DIO_write(LCD_PORT,D4,GET_BIT(ins,0));
	DIO_write(LCD_PORT,EN,HIGH);
	_delay_ms(1);
	DIO_write(LCD_PORT,EN,LOW);
	_delay_ms(1);
